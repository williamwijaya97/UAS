...
--
-- Host: localhost:3306
-- Generation Time: Apr 09, 2021 at 07:19 PM
...
INSERT INTO `area` (`id`, `Provinsi`, `Kota`, `Kecamatan`) VALUES
('1', 'JAWA BARAT', 'BANDUNG', 'LENGKONG'),
('10', 'JAWA TENGAH', 'BANJARNEGARA', 'PAGEDONGAN'),
('11', 'JAWA TENGAH', 'BANJARNEGARA', 'SUSUKAN'),
('12', 'JAWA TENGAH', 'BANJARNEGARA', 'WANAYASA'),
('13', 'JAWA TENGAH', 'BANYUMAS', 'BATURADEN'),
('14', 'JAWA TENGAH', 'BANYUMAS', 'CILONGOK'),
('15', 'JAWA TENGAH', 'BANYUMAS', 'JATILAWANG'),
('16', 'JAWA TENGAH', 'BREBES', 'BUMIAYU'),
('17', 'JAWA TENGAH', 'BREBES', 'JATIBARANG'),
('18', 'JAWA TENGAH', 'BREBES', 'LOSARI'),
('2', 'JAWA BARAT', 'BANDUNG', 'CIDADAP'),
('3', 'JAWA BARAT', 'BANDUNG', 'SUKAJADI'),
('4', 'JAWA BARAT', 'CIREBON', 'HARJAMUKTI'),
('5', 'JAWA BARAT', 'CIREBON', 'KEJAKSAN'),
('6', 'JAWA BARAT', 'CIREBON', 'KESAMBI'),
('7', 'JAWA BARAT', 'KUNINGAN', 'MANDIRANCAN'),
('8', 'JAWA BARAT', 'KUNINGAN', 'CILIMUS'),
('9', 'JAWA BARAT', 'KUNINGAN', 'PANCALANG');
...
INSERT INTO `data_pendaftar` (`nik`, `nama_pendaftar`, `kelamin`, `tgl_lahir`, `umur`, `alamat`, `no_hp`, `wilayah`, `nama_faskes`) VALUES
('313456432564343', 'AZZAHRA', 'PEREMPUAN', '2002-01-01', '18', 'JL. LINGKAR 2', '089434623425', 'BANTEN', 'PUSKESMAS KEL. JELAMBAR '),
('31765537463338', 'ANNISA RAHMA', 'PEREMPUAN', '1999-02-04', '22', 'JL. KELUAR', '089736436743', 'DKI JAKARTA', 'PUSKESMAS SETU'),
('3218748463231', 'SIGIT MAULANA', 'Laki - Laki', '1998-10-20', '23', 'JL. LINGKAR LINGKAR', '0873264252323', 'BANTEN', 'PUSKESMAS GONDRONG'),
('345234534335444', 'SIDIK', 'LAKI - LAKI', '1999-02-02', '33', 'JL. BENDA', '089454656362', 'DKI JAKARTA', 'PUSKESMAS SETU'),
('736385635347463', 'CINTA LAURA', 'PEREMPUAN', '2000-03-03', '22', 'JL. PEDALAMAN', '0896335447362', 'DKI JAKARTA', 'PUSKESMAS PAMULANG');

-- --------------------------------------------------------

--
-- Table structure for table `jfaskes`
--

CREATE TABLE `jfaskes` (
...
--
-- Dumping data for table `jfaskes`
--

INSERT INTO `jfaskes` (`id`, `name`) VALUES
('11', 'PUSKESMAS'),
('12', 'RSUD');
...
CREATE TABLE `kabkota` (
  ...
  `propinsi_id` char(2) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `kabkota` (`id`, `propinsi_id`, `name`) VALUES
...
CREATE TABLE `kecamatan` (
  ...
  `kabkota_id` char(4) COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `kecamatan` (`id`, `kabkota_id`, `name`) VALUES
...
--
-- Table structure for table `nfaskes`
--

CREATE TABLE `nfaskes` (
  `id` char(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `jfaskes_id` char(2) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `nfaskes`
--

INSERT INTO `nfaskes` (`id`, `jfaskes_id`, `name`) VALUES
('1101', '11', 'PUSKESMAS GONDRONG'),
('1102', '11', 'PUSKESMAS CIPADU'),
('1103', '11', 'PUSKESMAS CIKOKOL '),
('1121', '11', 'PUSKESMAS CIPUTAT '),
('1122', '11', 'PUSKESMAS PAMULANG'),
('1123', '11', 'PUSKESMAS SETU'),
('1131', '11', 'PUSKESMAS KEL. JELAMBAR '),
('1132', '11', 'PUSKESMAS KEC. CENGKARENG '),
('1201', '12', 'RSUD KOTA TANGERANG '),
('1202', '12', 'RS HERMINA TANGERANG '),
('1203', '12', 'RS ISLAM SARI ASIH AR-RAHMAH'),
('1221', '12', 'RS. SARI ASIH CIPUTAT'),
('1222', '12', 'RSU TANGERANG SELATAN '),
('1223', '12', 'RS HERMINA CIPUTAT'),
('1231', '12', 'RS HERMINA DAAN MOGOT '),
('1232', '12', 'RSUD KALIDERES'),
('1241', '12', 'RS PUSAT PERTAMINA '),
('1242', '12', 'RS BHAYANGKARA LEMDIKLAT POLRI');
...
('171011400472', 'WILLIAM WIJAYA', '02111226', 'unpam'),
('171011450335', 'SITI AISYAH FEBRIYATUN', '02111222', 'unpam'),
('171011450351', 'TAOFIK HIDAYAT', '02111223', 'unpam'),
('171011450356', 'ZULFAHMI SENGAJI', '02111227', 'unpam'),
('171011450366', 'WAHYU DWI ANGGORO', '02111225', 'unpam'),
('171011450530', 'WAHYOGI', '02111224', 'unpam'),
('171011450544', 'SIGIT MAULANA', '02111221', 'unpam');
...
ALTER TABLE `kabkota`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kabkota_propinsi_id_index` (`propinsi_id`) USING BTREE;
...
ALTER TABLE `kecamatan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kecamatan_id_index` (`kabkota_id`) USING BTREE;

--
-- Indexes for table `nfaskes`
--
ALTER TABLE `nfaskes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `nfaskes_jfaskes_id_index` (`jfaskes_id`) USING BTREE;
...
--
ALTER TABLE `kabkota`
  ADD CONSTRAINT `kabkota_propinsi_id_foreign` FOREIGN KEY (`propinsi_id`) REFERENCES `propinsi` (`id`);

--
-- Constraints for table `kecamatan`
--
ALTER TABLE `kecamatan`
  ADD CONSTRAINT `districts_regency_id_foreign` FOREIGN KEY (`kabkota_id`) REFERENCES `kabkota` (`id`);

--
-- Constraints for table `nfaskes`
--
ALTER TABLE `nfaskes`
  ADD CONSTRAINT `nfaskes_jfaskes_id_Foreignkey` FOREIGN KEY (`jfaskes_id`) REFERENCES `jfaskes` (`id`);
COMMIT;
